...
-- CreateEnum
CREATE TYPE "InventoryChangeReason" AS ENUM ('restock', 'sale', 'adjustment', 'return');
...
-- AddForeignKey
ALTER TABLE "inventory_logs" ADD CONSTRAINT "inventory_logs_actorUserId_fkey" FOREIGN KEY ("actorUserId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
